"""National Rail Darwin SOAP API client for Home Assistant."""
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
    ...
    async def async_get_departure_board(
        self,
        station_crs: str,
        num_rows: int = 3,
        destination_crs: Optional[str] = None,
        ...
        """Get the departure board for a station asynchronously."""
        try:
    ...
    def get_departure_board(
        ...
        """Synchronous wrapper for get_departure_board."""
        return asyncio.get_event_loop().run_until_complete(
            self.async_get_departure_board(station_crs, num_rows, destination_crs)
        )
    ...
    def test_connection(self) -> bool:
        ...
        try:
            self.get_departure_board("PAD", num_rows=1)
            return True
        except DarwinApiError:
            return False
